...
function!	Insert_header_42_add_mail()
	let l:mail = system("echo $MAILEXIA | tr -d '\n'")
...
function!	Insert_header_42_add_file()
	...
	let l:len = system(l:cmd)
	let l:space = 48 - l:len
	while l:space >= 0
		let l:line = l:line . " "
		let l:space -= 1
	endwhile
	let l:line = l:line . "__       __ __	          */"
	call append(3, l:line)
endfunction

function!	Insert_header_42()
	let s:author = system("echo $USEREXIA | tr -d '\n'")
	call append(0, "/* ************************************************************************** */")
	call append(1, "/*                                                                            */")
	call append(2, "/*                                                                            */")
	...
	call append(6, "/*                                                  |     /\\    |     /____\\  */")
	call Insert_header_42_add_info("Created", "|__  /  \\ __|__  /      \\ */", 7, 0)
	call Insert_header_42_add_info("Updated", "                          */", 8, 0)
	call append(9, "/*                                                                            */")
	call append(10, "/* ************************************************************************** */")
	call append(11, "")
	unlet s:author
...
function!	Update_header_42()
	...
	if match(l:line, l:pattern) != -1
		call Insert_header_42_add_info("Updated", "                          */", 9, 1)
	endif
	unlet s:author
endfunction
...
function!	Insert_header_42_Makefile()
	...
	call Insert_header_42_add_info_Makefile("Updated", "                          */", 9, 0)
	call append(9, "#*                                                                            *#")
	call append(10, "#* ************************************************************************** *#")
	call append(11, "")
	unlet s:author
...
function!	Update_header_42_Makefile()
	...
	let l:line = getline(9)
	if match(l:line, l:pattern) != -1
		call Insert_header_42_add_info_Makefile("Updated", "                          */", 9, 1)
	endif
	unlet s:author
endfunction
